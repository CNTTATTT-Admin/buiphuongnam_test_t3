    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#2b1d4c] mb-2">
            MentorMatch
          </h1>
          <p className="text-sm text-slate-500">
            Kết nối tri thức, định hướng tương lai
          </p>
        </div>
        ...
        {error && (
          <div className="mb-4 p-3 bg-red-50 border border-red-100 text-red-600 text-sm font-medium rounded-lg text-center break-words">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                {isLogin && (
                  <a
                    href="#"
                    className="text-xs font-semibold text-[#372660] hover:underline"
                  >
                    Quên mật khẩu?
                  </a>
                )}
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full mt-6 bg-[#372660] hover:bg-[#2b1d4c] text-white py-6 rounded-xl font-semibold text-base transition-colors shadow-md shadow-[#372660]/20 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading
              ? "Đang xử lý..."
              : isLogin
        ...
        <Button
          ...
          variant="outline"
          className="w-full py-6 rounded-xl border-slate-200 hover:bg-slate-50 text-slate-700 font-medium transition-colors"
        >
